...
func (a *Application) StartServer() {
	...
	protected.GET("messenger/chat2/:id_chat", a.GetChat)
	protected.POST("/messenger/chat2", a.CreateChat)
	protected.DELETE("/messenger/chat2/:id_chat", a.DeleteChat)
	//protected.PUT("messenger/chat2/avatar", a.ChangePhoto)
	//protected.PUT("messenger/chat2/description", a.ChangeDescription)

	//protected.GET("messenger/chat2/users/:id_chat", a.GetChatUsers)
	//protected.POST("messenger/chat2/users/:id_chat", a.InviteUser)
	//protected.DELETE("messenger/chat2/users/:id_chat", a.DeleteChatUser)
	//protected.PUT("messenger/chat2/users/:id_chat", a.ChangeChatRole)
